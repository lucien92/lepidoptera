...
class YOLO(object):
    ...
    def train(self, train_imgs,  # the list of images to train the model
              ...
              optimizer_config,
              mosaic='none',
              saved_pickles_path='/content/lepidoptera/script/lepidoptere_detection/src/data/pickles',
              saved_weights_name='/content/lepidoptera/script/lepidoptere_detection/src/data/saved_weights/best_model_bestLoss.h5',
              workers=3,
              max_queue_size=8,
              early_stop=True,
              tb_logdir="./",
        ...
        #print("longueur initale de train_img",len(train_imgs))
        ...
        # ckp_best_loss = ModelCheckpoint("/home/lucien/projet_lepinoc/bees_detection/src/data/saved_weights/benchmark_weights/model",
        #                                 monitor='val_loss',
        #                                 verbose=1,
        #                                 save_best_only=True,
        #                                 mode='min',
        ...
        #############################
        # print('look', len(train_generator))
        # #on veut afficher les images du train_generator car apparemment il n'en donne que 2
        # for i in range(len(train_generator)):
        #     print(train_generator[i][0].shape)
        #     print(train_generator[i][1])
