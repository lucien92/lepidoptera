...
class YOLO(object):
    ...
    def train(self, train_imgs,  # the list of images to train the model
              ...
              optimizer_config,
              mosaic='none',
              saved_pickles_path='/home/lucien/projet_lepinoc/bees_detection/src/data/pickles',
              saved_weights_name='/home/lucien/projet_lepinoc/bees_detection/src/data/saved_weights/best_model_bestLoss.h5',
              workers=3,
              max_queue_size=8,
              early_stop=True,
              tb_logdir="./",
