...
def decode_netout(netout, anchors, nb_class, obj_threshold, nms_threshold): #obj treshold is the threshold for the confidence score, nms_threshold is the threshold pour le iou score
